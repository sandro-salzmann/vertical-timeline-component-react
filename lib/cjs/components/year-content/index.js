...
var YearContent = function (_a) {
    var startDate = _a.startDate, endDate = _a.endDate, _b = _a.currentYear, currentYear = _b === void 0 ? false : _b, _c = _a.fromLabel, fromLabel = _c === void 0 ? false : _c;
    var _d = (0, react_1.useContext)(config_context_1.ConfigContext), lang = _d.lang, dateFormat = _d.dateFormat;
    ...
    var _startDate = (react_1.default.createElement(react_1.default.Fragment, null,
        fromLabel && react_1.default.createElement(main_1.YearSpan, null, config_1.mapText[_lang].from),
